export const caseStudies = [
  {
    ...
    company: 'Design Operations • Education Technology',
    year:    '2014-2016',
  ...
  },
  {
    ...
    tags:    ['Consumer LLM Use', 'Discovery Experience', 'AI Strategy'],
    color:   '#10B981',
  ...
  },
  {
    ...
    index:   '05',
    title:   'Getting Quality from Quantity | Scaling Revenue Generator from Behavioral Metrics',
  ...
  },
  {
    ...
    year:    '2025',
    outcome: 'A unified "source of truth" that creates bilateral accountability, ensures product consistency, and improves communication between design, engineering, product, and business units.',
